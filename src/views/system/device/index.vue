<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="租金/月" prop="rentPerMonth">
        <el-input
          v-model="queryParams.rentPerMonth"
          placeholder="请输入租金/月"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <!-- <el-form-item label="热点 用于推荐" prop="hots">
        <el-input
          v-model="queryParams.hots"
          placeholder="请输入热点 用于推荐"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item> -->
    ...
    <el-table v-loading="loading" :data="deviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="租金/月" align="center" prop="rentPerMonth" />
      <el-table-column label="押金" align="center" prop="deposit" />
      <el-table-column label="图片" align="center" prop="picture" />
      <el-table-column label="热点 用于推荐" align="center" prop="hots" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="租金/月" prop="rentPerMonth">
          <el-input v-model="form.rentPerMonth" placeholder="请输入租金/月" />
        </el-form-item>
        <el-form-item label="押金" prop="deposit">
        ...
        <el-form-item label="热点 用于推荐" prop="hots">
          <el-input v-model="form.hots" placeholder="请输入热点 用于推荐" />
        </el-form-item>
      </el-form>
